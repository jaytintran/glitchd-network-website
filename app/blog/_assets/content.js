...
export const categories = [
	{
		...
		descriptionShort: "Latest features added.",
	},
	{
...
export const articles = [
			...
			<>
				...
				<section>
					...
					<p className={styles.p}>
						...
						tool for building a backend for your app!
					</p>
				</section>
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
				...
				<section>
					<h3 className={styles.h3}>2. Add your credentials to </h3>
					<p className={styles.p}>
						Copy the <span className={styles.codeInline}>API URL</span> and{" "}
						<span className={styles.codeInline}>API Key</span> from your
						Supabase project settings and add them to your project settings. Add
